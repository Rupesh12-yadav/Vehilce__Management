            ...
            <div className="flex gap-3">
              {socialLinks.map((social, idx) => (
                <a 
                  key={idx}
                  href="#" 
                  className={`w-10 h-10 bg-gray-700/50 rounded-xl flex items-center justify-center text-gray-400 hover:text-white transition-all ${social.color}`}
                >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">support@rentease.com</span>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">Bhopal, MP, India</span>
              </li>
            </ul>
          </div>
        </div>
